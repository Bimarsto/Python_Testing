...
def purchasePlaces():
    ...
    competition_time = datetime.datetime.strptime(
        competition['date'],
        "%Y-%m-%d %H:%M:%S"
    )
    ...
    elif competition_time < datetime.datetime.now():
        flash('This competition is already passed.')
    else:
...
def club_details():
    return render_template('clubs_details.html', clubs=clubs)
